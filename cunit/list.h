...
typedef void (*destroy_list_content)(void*);

bool isexist(list_t * head, void*address, cmp_func cmp );
void *return_shelf(list_t *head);
void print_link_list(list_t*head);
void *list_get_shelf(list_t *head, int index);
void freeList(list_t*list, destroy_list_content);
list_t* copyList(list_t*list);
